...
export const Navbar = () => {
    ...
    const [isNav, setIsNav] = useState(-1000);
    ...
    return(
        ...
        <nav className="bg-[#000C23] flex items-center justify-around p-[10px]">
            ...
            <ul className={`flex-col items-start gap-[25px] md:gap-[35px] flex md:flex-row md:justify-center fixed bg-[#000C23] duration-500 ease-in animation left-[${isNav}px] md:left-0 w-[50%] top-0 px-[20px] md:px-0   py-[100px] bottom-0 md:py-[10px] md:relative`}>
